...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    ...
    <div className="ha-summary-row">
      ...
      <p>Hongdae, Seongsu, Sinsa, Myeongdong, and Hannam each solve different shopping problems, so one focused route usually beats a rushed all-district day.</p>
    </div>
  </div>
</div>
...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/seoul-street-fashion-trends">
      ...
      <p className="ha-related-copy">Understand how each district changes the way the same outfit reads before building a shopping route.</p>
    </a>
