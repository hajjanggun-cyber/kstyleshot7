...
If you want the wider city logic behind where this route sits, [Seoul Photo Spot Guide](/en/hub/seoul-photo-spot-guide) is the best hub to keep nearby.
...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    ...
    <a className="ha-related-card" href="/en/hub/seongsu-hub">
      ...
      <p className="ha-related-copy">Compare Seongsu with Itaewon next if you want to see how Seoul's trend-heavy street neighborhoods branch into different moods.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/hongdae-hub">
      <span className="ha-related-eyebrow">Also read</span>
      <strong className="ha-related-title">Hongdae Guide</strong>
      <p className="ha-related-copy">Hongdae is the clearest comparison if you want another fast, youthful street route beside Itaewon's more mixed international atmosphere.</p>
    </a>
  </div>
</div>
