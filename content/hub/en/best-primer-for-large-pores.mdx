...
description: "Find the best primer for large pores by matching pore-blurring primer texture, base finish, and placement method instead of coating the whole face in a heavier smoothing layer."
...
If the face also deals with active breakouts, [Makeup Tips for Acne-Prone Skin](/en/hub/makeup-tips-for-acne-prone-skin) is the better companion article because it separates blemish coverage logic from pore smoothing logic.
...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/skincare-by-skin-concern">
      ...
      <p className="ha-related-copy">Use the hub first if you want the wider structure that sorts pore care, breakouts, and sensitivity together.</p>
    </a>
