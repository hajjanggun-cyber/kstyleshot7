...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    ...
    <a className="ha-related-card" href="/en/hub/eye-makeup-tips">
      ...
      <strong className="ha-related-title">Eye Makeup Guide for Balance, Liner, and Lashes</strong>
      <p className="ha-related-copy">Use this if you want to see how new bangs and face-framing layers change the visual center around the eyes.</p>
    </a>
  </div>
</div>
