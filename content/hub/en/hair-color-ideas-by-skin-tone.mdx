...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/personal-color-hair-dye-guide">
      <span className="ha-related-eyebrow">Read first</span>
      <strong className="ha-related-title">Personal Color Hair Dye Guide by Seasonal Type</strong>
      <p className="ha-related-copy">The first follow-up from the color hub is usually the seasonal route, because it narrows undertone direction quickly.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/how-to-maintain-ash-brown-hair">
      ...
      <p className="ha-related-copy">Read this next if ash brown is already the target and you want the practical routine for early fade, brassiness, and re-toning timing.</p>
    </a>
  </div>
</div>
