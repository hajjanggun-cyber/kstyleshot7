...
pullQuote: "fairycore styling becomes more wearable when airy fabric, muted color, and small lace details are balanced with a clear waistline and grounded shoes."
...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    <div className="ha-summary-row">
      ...
      <p>A wearable fairycore outfit usually works better with one main soft element, such as chiffon, lace, or muted pastel, instead of using every dreamy detail at once.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">2</span>
      <p>Greyed mint, dusty lavender, cream, sage, and cloudy pink often look more polished than bright candy pastels.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">3</span>
      <p>The softer the fabric becomes, the more the outfit needs a clear waistline, grounded shoes, or a structured bag.</p>
    </div>
  </div>
</div>
