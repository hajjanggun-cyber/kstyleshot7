...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    <div className="ha-summary-row">
      ...
      <p>Body-shape styling works best when you check outfit lines: neck, waist, hem, volume balance, and shoe support.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">2</span>
      <p>Petite proportions need a higher starting point, broad shoulders need softer vertical direction, and lower-body coverage needs a moving line instead of extra fabric.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">3</span>
      <p>Slim upper bodies, waist-to-hip fit differences, and relaxed K-style silhouettes all require separate fit checks rather than one universal size rule.</p>
    </div>
  </div>
</div>
...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    ...
    <a className="ha-related-card" href="/en/hub/oversized-blazer-outfit-guide">
      ...
      <p className="ha-related-copy">Check shoulder seams, sleeve length, and blazer hems before choosing an oversized jacket.</p>
    </a>
