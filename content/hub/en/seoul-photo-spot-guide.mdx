...
The sub-guides that follow this hub will narrow that logic into Itaewon, Seochon, Ikseon-dong, Euljiro, Seoul Forest, Seokchon Lake, Naksan Park, and cherry blossom-focused routes.
...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/bukchon-hanok-village-hub">
      ...
      <p className="ha-related-copy">Start here if you want the strongest hanok-alley reference point before comparing it with other Seoul photo routes.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/seongsu-hub">
      ...
      <p className="ha-related-copy">Use Seongsu as the cleanest contrast if you want trend-heavy cafes, pop-ups, and a more current street mood than traditional Seoul.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/han-river-night-photo-spots">
      <span className="ha-related-eyebrow">Also read</span>
      <strong className="ha-related-title">Han River Night Photo Spots Guide</strong>
      <p className="ha-related-copy">Read this next if you want Seoul photo spots built more around scale, skyline light, and open riverside compositions.</p>
    </a>
  </div>
</div>
