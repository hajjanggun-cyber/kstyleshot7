...
description: "Use this girl crush style outfit guide to build stronger outfits through jacket length, waist compression, boots styling, and sharper silhouette control instead of relying on black clothing alone."
...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    <div className="ha-summary-row">
      ...
      <p>Girl crush outfits rely more on waist control, jacket length, and boot weight than on black clothing alone.</p>
    </div>
    <div className="ha-summary-row">
