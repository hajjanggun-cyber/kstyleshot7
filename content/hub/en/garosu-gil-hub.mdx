...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/garosu-gil-cafe-photo-spots">
      ...
      <p className="ha-related-copy">Use this first if you want to narrow the district into window-seat cafes, terraces, and easier photo-friendly stops.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/garosu-gil-shopping-walk-guide">
      ...
      <p className="ha-related-copy">Continue here if you want the browsing rhythm, select-shop flow, and weekend timing that shape the wider walk.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/garosu-gil-evening-walk-guide">
      ...
      <p className="ha-related-copy">Read this next if you want the softer evening atmosphere that makes Garosu-gil feel strongest as a slow Seoul stroll.</p>
    </a>
  </div>
</div>
