...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/gyeongbokgung-nearby-hanok-photo-spots">
      ...
      <p className="ha-related-copy">Use this if you want to compare Bukchon alley views with the hanok scenery that opens out from the Gyeongbokgung side.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/gyeongbokgung-hub">
      <span className="ha-related-eyebrow">Hub guide</span>
      <strong className="ha-related-title">Gyeongbokgung Palace Tour Guide</strong>
      <p className="ha-related-copy">Read this next if you want the broader palace route and a clearer contrast between royal-scale and alley-scale traditional Seoul.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/insadong-hub">
      ...
      <p className="ha-related-copy">Bukchon is alley-centered and residential in feel, while Insadong reads more clearly as a traditional walking street. They compare well together.</p>
    </a>
  </div>
</div>
