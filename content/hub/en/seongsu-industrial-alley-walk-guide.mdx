...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    ...
    <a className="ha-related-card" href="/en/hub/hongdae-vs-seongsu-street-fashion">
      ...
      <p className="ha-related-copy">Use this comparison if you want to understand how Seongsu's background density differs from another major Seoul trend district.</p>
    </a>
  </div>
</div>
