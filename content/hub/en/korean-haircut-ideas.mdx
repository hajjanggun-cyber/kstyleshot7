...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    <div className="ha-summary-row">
      ...
      <p>The most useful Korean haircut ideas start with face shape, hair volume, and styling time before they narrow into cut names.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">2</span>
      <p>Hush cuts usually create clearer movement, while layered haircuts often keep maintenance and silhouette more stable.</p>
    </div>
    <div className="ha-summary-row">
      <span className="ha-summary-num">3</span>
      <p>Bangs and salon consultation details matter almost as much as the haircut itself because they change daily wear more than trend photos suggest.</p>
    </div>
  </div>
</div>
