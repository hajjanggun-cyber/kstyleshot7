...
pullQuote: "the best makeup tips for acne-prone skin usually come from reducing friction, thickness, and unnecessary coverage before they come from buying stronger makeup."
...
If enlarged pores are the bigger issue than inflamed breakouts, [Best Primer for Large Pores](/en/hub/best-primer-for-large-pores) is the cleaner companion read because it separates pore-blurring primer logic from breakout coverage decisions.
...
If your main concern is pore texture and makeup base blur rather than inflamed breakouts, [Best Primer for Large Pores](/en/hub/best-primer-for-large-pores) is the next article to read. It focuses on smoothing makeup base decisions in a more targeted way.
...
<div className="ha-summary">
  ...
  <div className="ha-summary-list">
    <div className="ha-summary-row">
      ...
      <p>Makeup tips for acne-prone skin work best when the overall base stays light and only the most distracting redness or marks are corrected precisely.</p>
    </div>
    <div className="ha-summary-row">
