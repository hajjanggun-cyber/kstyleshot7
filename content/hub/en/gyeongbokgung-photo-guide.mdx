...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/gyeongbokgung-hub">
      ...
      <p className="ha-related-copy">For the broader context behind this area, start with the Gyeongbokgung Palace Seoul Guide.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/gyeongbokgung-light-timing-guide">
      ...
      <p className="ha-related-copy">If you want to compare these spots by light rather than location, continue with the Best Time to Photograph Gyeongbokgung guide.</p>
    </a>
  </div>
</div>
