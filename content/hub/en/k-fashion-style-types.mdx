...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/k-style-layered-necklace-guide">
      <span className="ha-related-eyebrow">Next guide</span>
      <strong className="ha-related-title">K-Style Layered Necklace Guide for Cleaner Daily Outfits</strong>
      <p className="ha-related-copy">Start here if you want the easiest real-life styling branch after this hub, using accessories instead of a full wardrobe reset.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/hongdae-vs-seongsu-street-fashion">
      ...
      <p className="ha-related-copy">Read this too if you want to see how the same style family can shift depending on the Seoul street setting around it.</p>
    </a>
  </div>
</div>
