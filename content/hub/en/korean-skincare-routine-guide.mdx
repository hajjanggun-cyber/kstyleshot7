...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/myeongdong-k-beauty-shopping-map">
      ...
      <p className="ha-related-copy">Use this guide if you want to turn skincare interest into a practical in-person store route in Seoul.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/myeongdong-hub">
      <span className="ha-related-eyebrow">Also read</span>
      <strong className="ha-related-title">Myeongdong Travel Guide</strong>
      <p className="ha-related-copy">Read this next if you want the broader district context around Seoul's busiest beauty-shopping area.</p>
    </a>
  </div>
</div>
