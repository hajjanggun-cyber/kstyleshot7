...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/k-fashion-style-types">
      <span className="ha-related-eyebrow">Style map</span>
      <strong className="ha-related-title">K-Fashion Style Types from Y2K to Girl Crush</strong>
      <p className="ha-related-copy">Use this wider style hub if you want to set the mood and silhouette direction before adding seasonal rules.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/k-fashion-wardrobe-essentials">
      ...
      <p className="ha-related-copy">Read this if you want to organize the basics that can repeat across multiple seasons before buying more pieces.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/techwear-style-outfit-guide">
      <span className="ha-related-eyebrow">Utility mood</span>
      <strong className="ha-related-title">Techwear Style Outfit Guide</strong>
      <p className="ha-related-copy">Use this guide when rain, wind, matte fabrics, and dark utility details are part of the seasonal outfit direction.</p>
    </a>
  </div>
</div>
