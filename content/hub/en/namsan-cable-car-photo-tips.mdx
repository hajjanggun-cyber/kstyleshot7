...
<div className="ha-related-panel">
  ...
  <div className="ha-related-grid">
    <a className="ha-related-card" href="/en/hub/n-seoul-tower-hub">
      ...
      <p className="ha-related-copy">For the broader Seoul context of this landmark, start with the N Seoul Tower Night View Guide.</p>
    </a>
    <a className="ha-related-card" href="/en/hub/n-seoul-tower-night-view-guide">
      ...
      <p className="ha-related-copy">If you want to decide where to pause after getting off, continue with the Best N Seoul Tower Night View Spots.</p>
    </a>
  </div>
</div>
