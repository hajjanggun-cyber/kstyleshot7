...
- 장소형, 방문형, 촬영형 글은 본문 중간 이후 구간에서 mid-CTA 텍스트 링크를 1회 우선 검토하고, 문맥상 자연스럽다면 넣는 것을 기본값으로 본다
...
1. `[021] Hub` 가로수길 허브
2. `[022] Sub [ ]` 가로수길 카페 포토존 추천
3. `[023] Sub [ ]` 가로수길 쇼핑 거리 산책 코스
4. `[024] Sub [ ]` 가로수길 저녁 산책과 분위기 포인트
