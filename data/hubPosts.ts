...
export const hubPosts: HubPost[] = [
  ...
  },
  {
    ...
    categoryStyle: "white-on-pink",
    title: "가로수길\n카페 포토존",
    subtitle: "창가 좌석, 골목 카페, 감성샷 시작 구간",
    bg: "linear-gradient(135deg, #7a4c2f 0%, #e2b071 100%)",
    titleColor: "#ffffff",
  ...
  },
  {
    ...
    categoryStyle: "cyan",
    title: "가로수길\n쇼핑 산책",
    subtitle: "편집숍, 주말 동선, 카페와 묶는 순서",
    bg: "linear-gradient(135deg, #2f3747 0%, #9fb3c8 100%)",
    titleColor: "#ffffff",
  ...
  },
  {
    ...
    categoryStyle: "white-on-pink",
    title: "가로수길 저녁 산책\n신사동 밤거리 무드",
    bg: "linear-gradient(135deg, #1e2437 0%, #d07b58 100%)",
    titleColor: "#ffffff",
  },
  {
...
export const hubPostsEn: HubPost[] = [
  ...
  },
  {
    ...
    categoryStyle: "white-on-pink",
    title: "Garosu-gil\nCafe Photo Spots",
    subtitle: "Window light, side lanes, and easier cafe shots",
    bg: "linear-gradient(135deg, #7a4c2f 0%, #e2b071 100%)",
    titleColor: "#ffffff",
    subtitleColor: "rgba(255,255,255,0.74)",
    watermark: "CAFE",
  },
  {
    ...
    categoryStyle: "cyan",
    title: "Garosu-gil\nShopping Walk",
    subtitle: "Select shops, weekend pace, and cafe order",
    bg: "linear-gradient(135deg, #2f3747 0%, #9fb3c8 100%)",
    titleColor: "#ffffff",
    subtitleColor: "rgba(255,255,255,0.72)",
    watermark: "SHOP",
